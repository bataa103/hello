        ...
        @foreach ($creditDetails as $credit)
            <div class="col-md-4 bank-card" data-bank="{{ $credit['bank'] }}" style="display: none;">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>Нийт Орлого: <span class="text-success">{{ number_format($credit['totalIncomes'], 2) }}.₮</span>
                        </p>
                        <p>Нийт Зарлага: <span class="text-danger">{{ number_format($credit['totalExpenses'], 2) }}.₮</span>
                        </p>
                        <p>Үлдэгдэл: <span class="text-primary">{{ number_format($credit['balance'], 2) }}.₮</span></p>
                        <div class="progress">
